...
$(function() {
  ...
  // makes connection
  var socket = io();
  var avatar = {joined: false, id: undefined, color: undefined};
  ...
  window.AFRAME.registerComponent('rotation-reader', {
    tick: function () {  
      ...
      if (Math.floor(Math.random() * 15) != 1) { return }
  ...
  window.AFRAME.registerComponent('init-avatar', {
    ...
    init: function () {
      ...
      var data = {rotation: rotation, position: position};
